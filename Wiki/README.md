...
3. Run `.\Wiki\publish-wiki.ps1` from the repository root to copy the `.mediawiki` pages into `DragonAgeToolset.wiki.git`, commit them, and push the wiki.
...
- Images live in `Wiki/assets/` in this repository instead of the wiki repo, keeping the wiki repo smaller.
